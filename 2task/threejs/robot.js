...
function gen_robot() {
    ...
    var left_upper_leg = gen_rect(2.0, 2);
    left_upper_leg.name = "left_upper_leg";
    var left_lower_leg = gen_rect(1.7, 4);
    left_lower_leg.name = "left_lower_leg";
    var left_foot = gen_rect(1.5, 0.7);
    left_foot.name = "left_foot";


    // right: upper leg, leg, foot
    var right_upper_leg = gen_rect(2.0, 2);
    right_upper_leg.name = "right_upper_leg";
    var right_lower_leg = gen_rect(1.7, 4);
    right_lower_leg.name = "right_lower_leg";
    var right_foot = gen_rect(1.5, 0.7);
    ...
    left_upper_leg.position.y = -4;
    left_lower_leg.position.y = -2.5;
    left_foot.position.y = -2.5;

    right_upper_leg.position.x = -0.8;
    right_upper_leg.position.y = -4;
    right_lower_leg.position.y = -2.5;
    right_foot.position.y = -2.5;
